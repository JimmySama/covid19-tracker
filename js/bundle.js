...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Search = function () {\n    function Search(query) {\n        _classCallCheck(this, Search);\n\n        this.query = query;\n    }\n\n    _createClass(Search, [{\n        key: \"getSearch\",\n        value: function () {\n            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n                var result;\n                return regeneratorRuntime.wrap(function _callee$(_context) {\n                    while (1) {\n                        switch (_context.prev = _context.next) {\n                            case 0:\n                                _context.prev = 0;\n                                _context.next = 3;\n                                return (0, _axios2.default)(\"https://covid19.mathdro.id/api/countries/\" + this.query);\n\n                            case 3:\n                                result = _context.sent;\n\n                                this.result = result.data;\n\n                                _context.next = 10;\n                                break;\n\n                            case 7:\n                                _context.prev = 7;\n                                _context.t0 = _context[\"catch\"](0);\n\n                                alert(\"Something Wrong\");\n\n                            case 10:\n                            case \"end\":\n                                return _context.stop();\n                        }\n                    }\n                }, _callee, this, [[0, 7]]);\n            }));\n\n            function getSearch() {\n                return _ref.apply(this, arguments);\n            }\n\n            return getSearch;\n        }()\n    }]);\n\n    return Search;\n}();\n\nexports.default = Search;\n\n//# sourceURL=webpack:///./src/js/models/Search.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.renderCountry = exports.clearTable = exports.getDeaths = exports.getRecovered = exports.getConfirmed = exports.showMyanmar = undefined;\n\nvar _Base = __webpack_require__(/*! ./Base */ \"./src/js/views/Base.js\");\n\nvar showMyanmar = exports.showMyanmar = function showMyanmar(data) {\n    var dataMyanmer = data.find(function (curr) {\n        return curr.countryRegion === 'Burma';\n    });\n    _Base.DOMs.myanmarCases.textContent = dataMyanmer.confirmed;\n    _Base.DOMs.myanmarRecovered.textContent = dataMyanmer.recovered;\n    _Base.DOMs.myanmarDeaths.textContent = dataMyanmer.deaths;\n};\nvar totalOfEachCountry = [];\nvar getConfirmed = exports.getConfirmed = function getConfirmed(data) {\n\n    var sortedArr = [];\n\n    var US = [];\n    var China = [];\n    var UK = [];\n    var France = [];\n    var Australia = [];\n    var Denmark = [];\n    var Canada = [];\n    var Netherlands = [];\n\n    var largeStateArr = [];\n    var sumArr = [];\n\n    data.forEach(function (curr) {\n        if (curr.countryRegion === \"US\") {\n            US.push(curr);\n        }\n        if (curr.countryRegion === 'China') {\n            China.push(curr);\n        }\n        if (curr.countryRegion === 'Canada') {\n            Canada.push(curr);\n        }\n        if (curr.countryRegion === 'Australia') {\n            Australia.push(curr);\n        }\n        if (curr.countryRegion === \"United Kingdom\") {\n            UK.push(curr);\n        }\n        if (curr.countryRegion === 'France') {\n            France.push(curr);\n        }\n        if (curr.countryRegion === 'Denmark') {\n            Denmark.push(curr);\n        }\n        if (curr.countryRegion === 'Netherlands') {\n            Netherlands.push(curr);\n        }\n    });\n\n    var getTotal = function getTotal(stateArr, state) {\n\n        var confirmed = 0;\n        var active = 0;\n        var recovered = 0;\n        var deaths = 0;\n        stateArr.forEach(function (curr) {\n\n            confirmed += curr.confirmed;\n        });\n        sumArr.push([state, confirmed]);\n    };\n\n    getTotal(US, \"US\");\n    getTotal(UK, \"United Kingdom\");\n    getTotal(Australia, \"Australia\");\n    getTotal(Canada, \"Canada\");\n    getTotal(France, \"France\");\n    getTotal(Denmark, \"Denmark\");\n    getTotal(Netherlands, \"Netherlands\");\n    getTotal(China, \"China\");\n\n    // console.log(sumArr);\n    data.forEach(function (curr) {\n        var selectedCountries = [\"US\", \"China\", \"United Kingdom\", \"Australia\", \"Canada\", \"France\", \"Denmark\", \"Netherlands\"];\n        if (selectedCountries.indexOf(curr.countryRegion) === -1) {\n            sumArr.push([curr.countryRegion, curr.confirmed]);\n        }\n    });\n\n    sumArr.sort(function (a, b) {\n        if (a[1] > b[1]) {\n            return -1;\n        }\n        if (a[1] < b[1]) {\n            return 1;\n        }\n    });\n\n    return sumArr;\n};\n\nvar getRecovered = exports.getRecovered = function getRecovered(data) {\n    // let US = [];\n    var China = [];\n    var UK = [];\n    var France = [];\n    var Australia = [];\n    var Denmark = [];\n    // let Canada = [];\n    var Netherlands = [];\n\n    var sumArr = [];\n\n    data.forEach(function (curr) {\n\n        if (curr.countryRegion === 'China') {\n            China.push(curr);\n        }\n\n        if (curr.countryRegion === 'Australia') {\n            Australia.push(curr);\n        }\n        if (curr.countryRegion === \"United Kingdom\") {\n            UK.push(curr);\n        }\n        if (curr.countryRegion === 'France') {\n            France.push(curr);\n        }\n        if (curr.countryRegion === 'Denmark') {\n            Denmark.push(curr);\n        }\n        if (curr.countryRegion === 'Netherlands') {\n            Netherlands.push(curr);\n        }\n    });\n\n    var getTotal = function getTotal(stateArr, state) {\n\n        var recovered = 0;\n\n        stateArr.forEach(function (curr) {\n\n            recovered += curr.recovered;\n        });\n        sumArr.push([state, recovered]);\n    };\n\n    getTotal(UK, \"United Kingdom\");\n    getTotal(Australia, \"Australia\");\n\n    getTotal(France, \"France\");\n    getTotal(Denmark, \"Denmark\");\n    getTotal(Netherlands, \"Netherlands\");\n    getTotal(China, \"China\");\n\n    data.forEach(function (curr) {\n        var selectedCountries = [\"China\", \"United Kingdom\", \"Australia\", \"France\", \"Denmark\", \"Netherlands\"];\n        if (selectedCountries.indexOf(curr.countryRegion) === -1) {\n            sumArr.push([curr.countryRegion, curr.recovered]);\n        }\n    });\n\n    //  console.log(sumArr);\n    return sumArr;\n};\n\nvar getDeaths = exports.getDeaths = function getDeaths(data) {\n    // console.log(data);\n    var US = [];\n    var China = [];\n    var UK = [];\n    var France = [];\n    var Australia = [];\n\n    var Canada = [];\n    var Netherlands = [];\n    var sumArr = [];\n\n    data.forEach(function (curr) {\n        if (curr.countryRegion === \"US\") {\n            US.push(curr);\n        }\n        if (curr.countryRegion === 'China') {\n            China.push(curr);\n        }\n        if (curr.countryRegion === 'Canada') {\n            Canada.push(curr);\n        }\n        if (curr.countryRegion === 'Australia') {\n            Australia.push(curr);\n        }\n        if (curr.countryRegion === \"United Kingdom\") {\n            UK.push(curr);\n        }\n        if (curr.countryRegion === 'France') {\n            France.push(curr);\n        }\n        if (curr.countryRegion === 'Netherlands') {\n            Netherlands.push(curr);\n        }\n    });\n    var getTotal = function getTotal(stateArr, state) {\n\n        var deaths = 0;\n\n        stateArr.forEach(function (curr) {\n\n            deaths += curr.deaths;\n        });\n        sumArr.push([state, deaths]);\n    };\n\n    getTotal(UK, \"United Kingdom\");\n    getTotal(Australia, \"Australia\");\n    getTotal(US, \"US\");\n    getTotal(France, \"France\");\n    getTotal(Canada, \"Canada\");\n    getTotal(Netherlands, \"Netherlands\");\n    getTotal(China, \"China\");\n\n    data.forEach(function (curr) {\n        var selectedCountries = [\"China\", \"United Kingdom\", \"Australia\", \"France\", \"Netherlands\", \"US\", \"Canada\"];\n        if (selectedCountries.indexOf(curr.countryRegion) === -1) {\n            sumArr.push([curr.countryRegion, curr.deaths]);\n        }\n    });\n    return sumArr;\n};\nvar clearTable = exports.clearTable = function clearTable() {\n    _Base.DOMs.totalCaseTable.innerHTML = \"\";\n};\nvar renderCountry = exports.renderCountry = function renderCountry(confirmed, recovered, deaths) {\n    var slide = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 1;\n    var prev = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 0;\n    var next = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 1;\n\n    var j = [];\n    confirmed.forEach(function (curr, index) {\n\n        var i = recovered.findIndex(function (el) {\n            return el[0] === curr[0];\n        });\n\n        // curr.push(re)\n        if (i !== -1) {\n            curr.push(recovered[i][1]);\n            // curr[2] = recovered[i][1];\n        } else if (i === -1) {\n            curr.push(\"N/A\");\n        }\n\n        var j = deaths.findIndex(function (el) {\n            return el[0] === curr[0];\n        });\n        if (j !== -1) {\n            curr.push(deaths[j][1]);\n        } else if (j === -1) {\n            curr.push(\"N/A\");\n        }\n\n        // console.log(curr);\n    });\n\n    var countries = confirmed.map(function (curr, index) {\n        return renderMarkUp(curr, index);\n    });\n    // console.log(countries);\n    if (prev >= 0 && next <= 19) {\n\n        countries.slice(prev * 10, next * 10).forEach(function (cur, index) {\n            _Base.DOMs.totalCaseTable.insertAdjacentHTML('beforeend', cur);\n        });\n    }\n};\nvar renderMarkUp = function renderMarkUp(country, index) {\n    var markUp = void 0;\n    if (index % 2 === 1) {\n        markUp = \"\\n            <tr>\\n                <td>\" + (0, _Base.formatNumber)(index + 1) + \"</td>\\n                <td>\" + (0, _Base.formatNumber)(country[0]) + \"</td>\\n                <td>\" + (0, _Base.formatNumber)(country[1]) + \"</td>\\n                <td>\" + (0, _Base.formatNumber)(country[2]) + \"</td>\\n                <td>\" + (0, _Base.formatNumber)(country[3]) + \"</td>\\n            </tr>\\n            \";\n    } else {\n        markUp = \"\\n            <tr class=\\\"table-back-light\\\">\\n                <td>\" + (0, _Base.formatNumber)(index + 1) + \"</td>\\n                <td>\" + (0, _Base.formatNumber)(country[0]) + \"</td>\\n                <td>\" + (0, _Base.formatNumber)(country[1]) + \"</td>\\n                <td>\" + (0, _Base.formatNumber)(country[2]) + \"</td>\\n                <td>\" + (0, _Base.formatNumber)(country[3]) + \"</td>\\n            </tr>\\n            \";\n    }\n\n    return markUp;\n};\n\n//# sourceURL=webpack:///./src/js/views/CountriesView.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.renderDefault = exports.renderSearchCountry = exports.clearTableData = exports.clearInput = exports.getInput = undefined;\n\nvar _Base = __webpack_require__(/*! ./Base */ \"./src/js/views/Base.js\");\n\nvar getInput = exports.getInput = function getInput() {\n    return _Base.DOMs.searchInput.value;\n};\nvar clearInput = exports.clearInput = function clearInput() {\n    _Base.DOMs.searchInput.value = '';\n};\nvar clearTableData = exports.clearTableData = function clearTableData() {\n    _Base.DOMs.searchTable.innerHTML = '';\n};\n\nvar renderSearchCountry = exports.renderSearchCountry = function renderSearchCountry(data, query) {\n\n    var markUp = '\\n        <tr class=\"table-back-light\">\\n            <td>1</td>\\n            <td>' + query.toUpperCase() + '</td>\\n            <td>' + (0, _Base.formatNumber)(data.confirmed.value) + '</td>\\n            <td>' + (0, _Base.formatNumber)(data.recovered.value) + '</td>\\n            <td>' + (0, _Base.formatNumber)(data.deaths.value) + '</td>\\n            \\n        </tr>\\n    ';\n\n    _Base.DOMs.searchTable.insertAdjacentHTML('beforeend', markUp);\n};\nvar renderDefault = exports.renderDefault = function renderDefault() {\n\n    var markUp = '\\n        <tr class=\"table-back-light\">\\n        <td>1</td>\\n        <td>COUNTRY</td>\\n        <td>&mdash;</td>\\n        <td>&mdash;</td>\\n        <td>&mdash;</td>\\n            \\n        </tr>\\n    ';\n\n    _Base.DOMs.searchTable.insertAdjacentHTML('beforeend', markUp);\n};\n\n//# sourceURL=webpack:///./src/js/views/SearchView.js?");

/***/ }),

/***/ "./src/js/views/TotalView.js":
/*!***********************************!*\
  !*** ./src/js/views/TotalView.js ***!
  \***********************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.showLastUpdate = exports.showDeathsTotal = exports.showRecoveredTotal = exports.showCasesTotal = undefined;\n\nvar _Base = __webpack_require__(/*! ./Base */ \"./src/js/views/Base.js\");\n\nvar showCasesTotal = exports.showCasesTotal = function showCasesTotal(data) {\n\n    _Base.DOMs.casesTotal.textContent = (0, _Base.formatNumber)(data);\n};\nvar showRecoveredTotal = exports.showRecoveredTotal = function showRecoveredTotal(data) {\n    _Base.DOMs.recoveredTotal.textContent = (0, _Base.formatNumber)(data);\n};\nvar showDeathsTotal = exports.showDeathsTotal = function showDeathsTotal(data) {\n\n    _Base.DOMs.deathsTotal.textContent = (0, _Base.formatNumber)(data);\n};\nvar showLastUpdate = exports.showLastUpdate = function showLastUpdate(data) {\n\n    _Base.DOMs.lastUpdate.textContent = \"last update: \" + data.split('T')[0];\n};\n\n//# sourceURL=webpack:///./src/js/views/TotalView.js?");
